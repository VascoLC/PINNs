...
for epoch in range(1, epochs+1):
    ...
    for batch in range(num_batches):
        ...
        with tf.GradientTape() as tape:
            total_loss, loss_u, loss_k, loss_ic, loss_bc, loss_pde = compute_loss(
                xt_domain = xt_dom,
    ...
    loss_history.append([epoch, total_loss.numpy(), loss_u.numpy(), loss_k.numpy(),loss_ic.numpy(),loss_bc.numpy(), loss_pde.numpy()])
