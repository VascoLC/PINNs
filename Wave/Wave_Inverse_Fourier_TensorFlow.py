...
class FourierPINN(tf.keras.Model):
    def __init__(self):
        ...
        self.hidden = [tf.keras.layers.Dense(200, activation="tanh") for _ in range(3)]
...
def compute_loss(xt_domain, l_bc, r_bc, xt_ic, u_ic, ut_ic, u_bc_l, u_bc_r, xt_obs, u_obs):
    ...
    return total_loss, {"pde": loss_pde,"ic1": loss_ic1,"ic2": loss_ic2,"lbc": loss_lbc,"rbc": loss_rbc,"data": loss_obs}
