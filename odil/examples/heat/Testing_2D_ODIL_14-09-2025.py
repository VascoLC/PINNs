...
def parse_args():
    ...
    parser.set_defaults(outdir="out_heat_inverse_teste_3")
    ...
    parser.set_defaults(plot_every=500, report_every=500, history_full=10, history_every=100, frames=12)
...
def plot_func(problem, state, epoch, frame, cbinfo=None):
    ...
    title0 = f"u epoch={epoch}" if args.plot_title else None
    title1 = f"k epoch={epoch}" if args.plot_title else None
